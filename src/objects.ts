...
export function isCorrect(question: Question, answer: string): boolean {
    const ques = question.expected.toLowerCase().trim();
    if (ques === answer.toLowerCase().trim()) {
        return true;
    }
    return false;
}
...
export function renameQuestion(question: Question, newName: string): Question {
    return (question = { ...question, name: newName });
}
...
export function publishQuestion(question: Question): Question {
    return (question = { ...question, published: !question.published });
}
...
export function mergeQuestion(
    ...
    return {
        ...
        options: contentQuestion.options ? [...contentQuestion.options] : [],
